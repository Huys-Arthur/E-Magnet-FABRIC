...
public class ModItems {
    ...
    // Items
    public static final Item BASIC_MAGNET = new MagnetItem(new Item.Settings().group(ItemGroup.TOOLS).maxCount(1),
            config.magnets.range_basic_magnet, config.magnets.capacity_basic_magnet, 32);
    public static final Item ADVANCED_MAGNET = new MagnetItem(
            new Item.Settings().group(ItemGroup.TOOLS).fireproof().maxCount(1), config.magnets.range_advanced_magnet,
